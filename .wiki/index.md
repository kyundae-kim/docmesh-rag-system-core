...
> Last updated: 2026-08-25 | Total pages: 35

## Entities
- [[dms-core]] — host가 제공한 engine·MinIO·storage component를 주입받아 문서 lifecycle·정합성 복구·public-safe metadata를 제공하는 DMS v0.10.0 Python SDK.
...
- [[public-api-surface]] — RAG Core와 DMS v0.9.0의 공식 import 경로, public 메서드, adapter contract를 정리한 API 개념 페이지.
- [[rag-service-architecture]] — RAGCore facade 아래 ingestion/retrieval/generation/metadata 책임 분리 구조.
- [[service-configuration-topology]] — 서비스별 환경변수 체계와 DMS v0.9.0 host-owned configuration 경계를 정리한 구성 토폴로지 페이지.
...
- [[settings-loading-and-validation]] — 환경변수 로드, 조건부 필수값 검증, DMS v0.9.0 host/factory 입력 검증 경계를 정리한 설정 개념 페이지.
...
## Queries
- [[applying-dms-core-as-document-storage]] — dms-core v0.9.0을 원문 lifecycle 경계로 적용하고 RAG metadata·user scope·삭제 복구와 결합하는 방법.
...
- [[verifying-dms-core-contract]] — dms-core v0.9.0의 공개 API, factory/direct 조립, lifecycle, idempotency, 복구, 보안 및 소비 프로젝트 회귀 계약을 검증하는 절차.
